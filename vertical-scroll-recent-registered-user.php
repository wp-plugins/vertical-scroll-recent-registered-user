...
function vsrru_control() 
{
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-registered-user/'>Click here</a> to see live demo. <br> 
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>Gopi</a>. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-registered-user/'>Click here</a> to post suggestion or comments or feedback. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-registered-user/'>Click here</a> to see live demo. <br> 
...
function vsrru_init()
{
	...
	{
		register_sidebar_widget('Vertical scroll recent registered user', 'vsrru_widget');
	}
	
	if(function_exists('register_widget_control')) 
	{
		register_widget_control(array('Vertical scroll recent registered user', 'widgets'), 'vsrru_control',400,400);
	} 
}
