...
Plugin URI: http://gopi.coolpage.biz/demo/2009/07/18/vertical-scroll-recent-registered-user/
Description: This plug-in will vertically scroll the recent registered user with avatar & date in sidebar..
Author: Gopi.R
Author URI:http://gopi.coolpage.biz/demo/2009/07/18/vertical-scroll-recent-registered-user/
Version: 1.0
*/
...
function vsrru_init()
{
	...
	{
		register_widget_control(array('Vertical scroll recent registered user', 'widgets'), 'vsrru_control');
	} 
}
